  ...
  return (
    ...
    <div className="container-desc__wrapper">
      <div className="container-desc">
        <p className="conttext">Nhưng mà hiện tại web này em chọn gì anh cũng hỏng biết được á</p>
        <p className="conttext">Anh code được tới đây hỏng biết ổn chưa nữa</p>
        <p className="conttext">Nên là có gì thì em nhắn anh với nhee</p>
        <p className="conttext">Xong roài nèee</p>
